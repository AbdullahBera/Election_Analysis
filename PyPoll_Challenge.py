...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if (votescounty > winning_county_count and votescounty_percentage > winning_county_percentage):
            winning_county_count = votescounty
            winning_county_percentage = votescounty_percentage

            winning_county = county_name

    # 7: Print the county with the largest turnout to the terminal.
    if (winning_county_percentage > turnout_number):
        turnout_name = winning_county
        turnout_number = winning_county_percentage
        turnout_results = (
            f'\n-------------------------'
            f'\nLargest County Turnout: {turnout_name}'
            f'\n-------------------------\n')
